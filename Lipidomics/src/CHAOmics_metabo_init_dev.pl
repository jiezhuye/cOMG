...
sub usage {
	print <<USAGE
Version:	DEMO
Update :	20160930 	(since 20151120)
----------------------------------------
Description:
...
Options
	...
	-func	each function will be ran step by step. You can continue by any step if needed.
			polish		formating dataset
